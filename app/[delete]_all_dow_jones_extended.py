...
hyper_parameter_folder = 'dow_jones_index_extended'

hyper_parameter_folder = os.path.join(parent_folder, 'data', hyper_parameter_folder)
hyper_parameter_folder_list = [hyper_parameter_folder]

delete_file_format_list = ['.txt']
