...
data_folder = os.path.join('a_share','a_share_z_new_f_regression_data')
...
# (2.) clf_path
clsfy_name = 'a_share_mlp_cv_z_score_regressor'
other_config_dict['clf_path'] = os.path.join(parent_folder, 'trained_classifiers', clsfy_name)

# (3.) topology_result_path
cv_f_t_t_save_path_mres = os.path.join(parent_folder, 'topology_feature_test', 'ashare_cv_z_score_regression_mres.txt')
cv_f_t_t_save_path_avg_pc = os.path.join(parent_folder, 'topology_feature_test', 'ashare_cv_z_score_regression_avg_pc.txt')
cv_f_t_t_save_path_polar = os.path.join(parent_folder, 'topology_feature_test', 'ashare_cv_z_score_regression_polar.txt')
...
# ----------------------------------------------------------------------------------------------------------------------
print("================================================================================")
print("Start testing for MLP's topology for regression! Features are scaled by Z-score!")
print("================================================================================")
