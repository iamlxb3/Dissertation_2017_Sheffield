...
# # ==========================================================================================================
a_share1 = Ashare()
input_folder = os.path.join(parent_folder, 'data', 'a_share', 'a_share_f_engineered_data')
save_folder = os.path.join(parent_folder, 'data', 'a_share', 'a_share_labeled_data')
test_folder = os.path.join(parent_folder, 'data', 'a_share', 'a_share_labeled_data_test')
a_share1.label_data(input_folder, save_folder, split_test = True, test_folder = test_folder, test_set_percent = 0.15)
# # ==========================================================================================================
...
test_folder = os.path.join(parent_folder, 'data', 'a_share', 'a_share_regression_data_test')
a_share1.regression(input_folder, save_folder, split_test = True, test_folder = test_folder, test_set_percent = 0.15)
# # ==========================================================================================================
