...
hyper_parameter_avg_f1_save_path = "{}_sort_by_average_f1.txt".format(data_preprocessing)
hyper_parameter_avg_f1_save_path = os.path.join(hyper_parameter_result_save_folder, hyper_parameter_avg_f1_save_path)
hyper_parameter_avg_accuracy_save_path = "{}_sort_by_average_accuracy.txt".format(data_preprocessing)
hyper_parameter_avg_accuracy_save_path = os.path.join(hyper_parameter_result_save_folder, hyper_parameter_avg_accuracy_save_path)
#
# sort by best
...
hyper_parameter_best_f1_save_path = "{}_sort_by_best_f1.txt".format(data_preprocessing)
hyper_parameter_best_f1_save_path = os.path.join(hyper_parameter_result_save_folder, hyper_parameter_best_f1_save_path)
hyper_parameter_best_accuracy_save_path = "{}_sort_by_best_accuracy.txt".format(data_preprocessing)
hyper_parameter_best_accuracy_save_path = os.path.join(hyper_parameter_result_save_folder, hyper_parameter_best_accuracy_save_path)
#
    ...
    with open(save_path, 'w') as f:
        for hyper_parameter_tuple, evaluation_metrics_tuple in hyper_parameter_list:
            ...
            if is_avg:
                ...
                evaluation_metrics_list[2] = 'f1: ' + evaluation_metrics_list[2]
                evaluation_metrics_list[3] = 'accuracy: ' + evaluation_metrics_list[3]
...
# (1.) sort by f1
hyper_parameter_avg_list_sort_by_rmse = sorted(hyper_parameter_avg_list, key = lambda x:x[1][2],  reverse=True)
save_hyper_parameter_result_to_file_regressor(hyper_parameter_avg_list_sort_by_rmse, hyper_parameter_avg_f1_save_path)

# (2.) sort by accuracy
hyper_parameter_avg_list_sort_by_avg_pc = sorted(hyper_parameter_avg_list, key = lambda x:x[1][3], reverse=True)
save_hyper_parameter_result_to_file_regressor(hyper_parameter_avg_list_sort_by_avg_pc, hyper_parameter_avg_accuracy_save_path)
...
# (1.) sort by f1
hyper_parameter_best_list_sort_by_rmse = sorted(hyper_parameter_best_list, key = lambda x:x[1][2],  reverse=True)
save_hyper_parameter_result_to_file_regressor(hyper_parameter_best_list_sort_by_rmse,
                                              hyper_parameter_best_f1_save_path, is_avg = False)
...
save_hyper_parameter_result_to_file_regressor(hyper_parameter_best_list_sort_by_avg_pc,
                                              hyper_parameter_best_accuracy_save_path, is_avg = False)
