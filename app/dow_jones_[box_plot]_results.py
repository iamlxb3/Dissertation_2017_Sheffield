...
# ----------------------------------------------------------------------------------------------------------------------
NUMBER_OF_TRAILS_LIST = [2,4,8,16,32,64,128]
...
stock_metrics_result_box_plot(metrics_result_dict, NUMBER_OF_TRAILS_LIST, ['avg_f1', 'accuracy'], title =
'MLP performance under different number of trails')
