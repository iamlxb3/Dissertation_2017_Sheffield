...
def stock_prediction_baseline_reg(train_data_folder_name, test_data_folder_name, is_random = False,
    ...
    # (2.) data folder
    train_data_folder = os.path.join('dow_jones_index_extended',train_data_folder_name)
    train_data_folder = os.path.join(parent_folder, 'data', train_data_folder)

    test_data_folder = os.path.join('dow_jones_index_extended',test_data_folder_name)
    ...
    for file_name  in file_name_list:
        ...
        stock_name = re.findall(r'[0-9\-]+_([A-Za-z]+)_', file_name)[0]
